...
public class GmailSender {
    private static final String TOKENS_DIRECTORY_PATH = "/opt/tomcat/webapps/miapp/tokens"; // Ruta absoluta para los tokens
    ...
    private static Credential getCredentials(final NetHttpTransport httpTransport, GsonFactory jsonFactory)
        ...
        // Usando tu dominio en lugar de la IP
        LocalServerReceiver receiver = new LocalServerReceiver.Builder()
                .setPort(8888)
                .setCallbackPath("/Callback")
                .setHost("histority.site")
                .build();
    ...
    public static void main(String[] args) throws Exception {
        // Ejemplo de envío de correo, descomentarlo para probar
        /*
